    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-center align-items-center">
                <div class="logo">
                    <a href="index.php"><img src="../images/logo.svg" alt="Logo"  style="width: 150px; height: 100px;"></a>
                </div>
                <!-- <span style="font-size: 18px;">Templete SYSTEM</span> -->
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  about" id="description">
                ...
                <li class="sidebar-item  about" id="description">
                    <a href="description" class='sidebar-link'>
